...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { MISO }]; #IO_L5N_T0_D07_14 Sch=ja[1]
...
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { SPI_SS[0] }]; #IO_L8P_T1_D11_14 Sch=ja[4]
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { SPI_SS[1] }]; #IO_L5P_T0_D06_14 Sch=ja[7]
set_property -dict { PACKAGE_PIN H19   IOSTANDARD LVCMOS33 } [get_ports { SPI_SS[2] }]; #IO_L4P_T0_D04_14 Sch=ja[8]
...
set_property -dict { PACKAGE_PIN G2 } [get_ports { vauxn4 }]; #IO_L1N_T0_AD4N_35 Sch=ain_n[15]
set_property -dict { PACKAGE_PIN G3 } [get_ports { vauxp4 }]; #IO_L1P_T0_AD4P_35 Sch=ain_p[15]
